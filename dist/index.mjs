// src/ChatWidget.tsx
import { useState as useState5, useRef as useRef4, useEffect as useEffect4, useCallback as useCallback3 } from "react";
...
function ChatProvider({ config, children }) {
  ...
  const pendingReplaces = useRef(/* @__PURE__ */ new Map());
  const pendingAttachTempIds = useRef(/* @__PURE__ */ new Set());
  const clientMsgMap = useRef(/* @__PURE__ */ new Map());
  const stateRef = useRef(state);
  useEffect(() => {
    stateRef.current = state;
  }, [state]);
  const lastTypingDispatch = useRef(null);
  useEffect(() => {
  ...
  const sendMessage = useCallback(async (content, type = "TEXT", replyToMessageId) => {
  ...
  const requestAgent = useCallback(async (reason) => {
  ...
  const setWidgetOpen = useCallback((open) => {
  ...
  const reopenSession = useCallback(async (sessionId) => {
    const cfg = configRef.current;
  ...
  return /* @__PURE__ */ jsx(ChatContext.Provider, { value: { state, actions, config }, children });
}
function useChat() {
...
var ChatIcon = () => /* @__PURE__ */ jsxs("svg", { width: "26", height: "26", viewBox: "0 0 24 24", fill: "none", children: [
  /* @__PURE__ */ jsx2("path", { d: "M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z", fill: "white", opacity: "0.95" }),
  /* @__PURE__ */ jsx2("circle", { cx: "8", cy: "10", r: "1", fill: "rgba(255,255,255,0.5)" }),
  /* @__PURE__ */ jsx2("circle", { cx: "12", cy: "10", r: "1", fill: "rgba(255,255,255,0.5)" }),
  /* @__PURE__ */ jsx2("circle", { cx: "16", cy: "10", r: "1", fill: "rgba(255,255,255,0.5)" })
] });
var CloseIcon = () => /* @__PURE__ */ jsxs("svg", { width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2.5", strokeLinecap: "round", children: [
  /* @__PURE__ */ jsx2("line", { x1: "18", y1: "6", x2: "6", y2: "18" }),
  /* @__PURE__ */ jsx2("line", { x1: "6", y1: "6", x2: "18", y2: "18" })
] });
var SendIcon = ({ active }) => /* @__PURE__ */ jsxs("svg", { width: "17", height: "17", viewBox: "0 0 24 24", fill: "none", children: [
  /* @__PURE__ */ jsx2("path", { d: "M22 2L11 13", stroke: active ? "white" : "#9ca3af", strokeWidth: "2.5", strokeLinecap: "round" }),
  /* @__PURE__ */ jsx2("path", { d: "M22 2L15 22L11 13L2 9L22 2Z", fill: active ? "white" : "#9ca3af" })
] });
var ChevronDownIcon = () => /* @__PURE__ */ jsx2("svg", { width: "18", height: "18", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2.5", strokeLinecap: "round", strokeLinejoin: "round", children: /* @__PURE__ */ jsx2("polyline", { points: "6 9 12 15 18 9" }) });
var BackIcon = () => /* @__PURE__ */ jsx2("svg", { width: "13", height: "13", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2.5", strokeLinecap: "round", strokeLinejoin: "round", children: /* @__PURE__ */ jsx2("polyline", { points: "15 18 9 12 15 6" }) });
var SpinnerIcon = ({ color = "#9ca3af", size = 16 }) => /* @__PURE__ */ jsxs("svg", { width: size, height: size, viewBox: "0 0 24 24", fill: "none", children: [
  /* @__PURE__ */ jsx2("circle", { cx: "12", cy: "12", r: "10", stroke: "#e5e7eb", strokeWidth: "3" }),
  /* @__PURE__ */ jsx2("path", { d: "M12 2a10 10 0 0 1 10 10", stroke: color, strokeWidth: "3", strokeLinecap: "round", children: /* @__PURE__ */ jsx2("animateTransform", { attributeName: "transform", type: "rotate", from: "0 12 12", to: "360 12 12", dur: "0.8s", repeatCount: "indefinite" }) })
] });
var PhoneDownIcon = () => /* @__PURE__ */ jsxs("svg", { width: "14", height: "14", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2.5", strokeLinecap: "round", strokeLinejoin: "round", children: [
  /* @__PURE__ */ jsx2("path", { d: "M10.68 13.31a16 16 0 003.41 2.6l1.27-1.27a2 2 0 012.11-.45 12.84 12.84 0 002.81.7 2 2 0 011.72 2v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07 19.42 19.42 0 01-3.33-3.33" }),
  /* @__PURE__ */ jsx2("line", { x1: "1", y1: "1", x2: "23", y2: "23" })
] });
var ReplyIcon = () => /* @__PURE__ */ jsxs("svg", { width: "13", height: "13", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2.5", strokeLinecap: "round", strokeLinejoin: "round", children: [
  /* @__PURE__ */ jsx2("polyline", { points: "9 17 4 12 9 7" }),
  /* @__PURE__ */ jsx2("path", { d: "M20 18v-2a4 4 0 00-4-4H4" })
] });

// src/widget/ChatContentInner.tsx
import { useState as useState4, useRef as useRef3, useEffect as useEffect3, useLayoutEffect, useCallback as useCallback2, useMemo } from "react";
...
var PURPLE = "#7c3aed";
var GREY = "#a0aec0";
var SingleTick = ({ color = GREY }) => /* @__PURE__ */ jsx3(
  "svg",
  {
    width: "14",
    height: "10",
...
var DoubleTick = ({ color = GREY }) => /* @__PURE__ */ jsxs2(
  "svg",
  {
    width: "18",
    height: "10",
...
var MessageTicks = React2.memo(function MessageTicks2({
  status,
  purple = PURPLE,
  style,
  showLabel = false,
  ...
  if (status === "sent") {
    return /* @__PURE__ */ jsxs2("span", { style: wrapper, children: [
      /* @__PURE__ */ jsx3(SingleTick, { color: GREY }),
      showLabel && /* @__PURE__ */ jsx3("span", { style: { fontSize: 10, color: GREY, fontWeight: 500, ...labelStyle }, children: "Sent" })
    ] });
  }
  if (status === "delivered") {
    return /* @__PURE__ */ jsxs2("span", { style: wrapper, children: [
      /* @__PURE__ */ jsx3(DoubleTick, { color: GREY }),
      showLabel && /* @__PURE__ */ jsx3("span", { style: { fontSize: 10, color: GREY, fontWeight: 500, ...labelStyle }, children: "Delivered" })
    ] });
  }
  return /* @__PURE__ */ jsxs2("span", { style: wrapper, children: [
    /* @__PURE__ */ jsx3(DoubleTick, { color: purple }),
    showLabel && /* @__PURE__ */ jsx3("span", { style: { fontSize: 10, color: purple, fontWeight: 700, ...labelStyle }, children: "Seen" })
  ] });
});
...
import React3, { useRef as useRef2, useState } from "react";
import { jsx as jsx4, jsxs as jsxs3 } from "react/jsx-runtime";
var CompactAudioPlayer = React3.memo(function CompactAudioPlayer2({ src, isCustomer }) {
  ...
  return /* @__PURE__ */ jsxs3("div", { style: { display: "flex", alignItems: "center", gap: "8px", width: "210px", height: "40px" }, children: [
    /* @__PURE__ */ jsx4(
      "audio",
      {
        ref: audioRef,
    ...
    /* @__PURE__ */ jsx4(
      "button",
      {
        ...
        children: playing ? /* @__PURE__ */ jsxs3("svg", { width: "11", height: "11", viewBox: "0 0 24 24", fill: "currentColor", children: [
          /* @__PURE__ */ jsx4("rect", { x: "5", y: "4", width: "4", height: "16", rx: "1" }),
          /* @__PURE__ */ jsx4("rect", { x: "15", y: "4", width: "4", height: "16", rx: "1" })
        ] }) : /* @__PURE__ */ jsx4("svg", { width: "11", height: "11", viewBox: "0 0 24 24", fill: "currentColor", children: /* @__PURE__ */ jsx4("polygon", { points: "6,4 20,12 6,20" }) })
      }
    ),
    /* @__PURE__ */ jsxs3("div", { style: { flex: 1, display: "flex", flexDirection: "column", gap: "4px" }, children: [
      /* @__PURE__ */ jsx4(
        "div",
        {
          ...
          children: /* @__PURE__ */ jsx4("div", { style: { height: "100%", width: `${progress * 100}%`, background: fillBg, borderRadius: "2px", transition: "width 0.1s linear" } })
        }
      ),
      /* @__PURE__ */ jsxs3("div", { style: { fontSize: "9px", color: accent, opacity: 0.8, lineHeight: 1 }, children: [
        fmt(current),
        " / ",
        fmt(duration || 0)
      ] })
...
function TypingIndicator({ styles }) {
  return /* @__PURE__ */ jsx5("div", { style: styles.typingWrap, children: [0, 0.2, 0.4].map((d, i) => /* @__PURE__ */ jsx5("div", { style: { ...styles.typingDot, animation: `chatTypingBounce 1.2s ${d}s infinite ease-in-out` } }, i)) });
}
function CustomerTick({ status }) {
  if (status === "none") return null;
  const W = "rgba(255,255,255,0.95)";
  const Wm = "rgba(255,255,255,0.65)";
  const Single = () => /* @__PURE__ */ jsx5("svg", { width: "14", height: "10", viewBox: "0 0 14 10", fill: "none", style: { display: "inline-block", verticalAlign: "middle", flexShrink: 0 }, children: /* @__PURE__ */ jsx5("polyline", { points: "1,5 5,9 13,1", stroke: Wm, strokeWidth: "1.8", strokeLinecap: "round", strokeLinejoin: "round" }) });
  const Double = ({ bright }) => /* @__PURE__ */ jsxs4("svg", { width: "18", height: "10", viewBox: "0 0 18 10", fill: "none", style: { display: "inline-block", verticalAlign: "middle", flexShrink: 0 }, children: [
    /* @__PURE__ */ jsx5("polyline", { points: "5,5 9,9 17,1", stroke: bright ? W : Wm, strokeWidth: "1.8", strokeLinecap: "round", strokeLinejoin: "round" }),
    /* @__PURE__ */ jsx5("polyline", { points: "1,5 5,9 13,1", stroke: bright ? W : Wm, strokeWidth: "1.8", strokeLinecap: "round", strokeLinejoin: "round" })
  ] });
  if (status === "sent") return /* @__PURE__ */ jsx5(Single, {});
  if (status === "delivered") return /* @__PURE__ */ jsx5(Double, { bright: false });
  return /* @__PURE__ */ jsxs4("span", { style: { display: "inline-flex", alignItems: "center", gap: 2 }, children: [
    /* @__PURE__ */ jsx5(Double, { bright: true }),
    /* @__PURE__ */ jsx5("span", { style: { fontSize: 9, fontWeight: 700, color: W, lineHeight: 1 }, children: "Seen" })
  ] });
}
var MessageBubble = React4.memo(function MessageBubble2({
  message,
  styles,
  onImageClick,
  onReply,
  ...
  if (isSystem) return /* @__PURE__ */ jsx5("div", { style: styles.bubbleSystem, children: message.content });
  ...
  const renderReplyQuote = () => {
    ...
    return /* @__PURE__ */ jsxs4(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsx5("div", { style: { fontWeight: 700, color: isCustomer ? "rgba(255,255,255,0.85)" : "#7c3aed", marginBottom: "2px" }, children: rName }),
          /* @__PURE__ */ jsx5("div", { style: { color: isCustomer ? "rgba(255,255,255,0.7)" : "#6b7280", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }, children: preview })
        ]
      }
    );
  };
  const renderAttachment = () => {
    ...
    if (effectiveType === "IMAGE") return /* @__PURE__ */ jsx5("div", { style: { cursor: "pointer" }, onClick: () => onImageClick?.(url, fileName), children: /* @__PURE__ */ jsx5("img", { src: url, alt: fileName, style: { maxWidth: "220px", maxHeight: "180px", borderRadius: "12px", objectFit: "cover", display: "block" }, loading: "lazy" }) });
    if (effectiveType === "VIDEO") return /* @__PURE__ */ jsx5("video", { src: url, controls: true, style: { maxWidth: "240px", maxHeight: "180px", borderRadius: "12px" }, preload: "metadata" });
    if (effectiveType === "AUDIO") return /* @__PURE__ */ jsx5(CompactAudioPlayer, { src: url, isCustomer });
    return /* @__PURE__ */ jsxs4("a", { href: url, target: "_blank", rel: "noopener noreferrer", style: { display: "flex", alignItems: "center", gap: "8px", padding: "8px 12px", borderRadius: "10px", backgroundColor: isCustomer ? "rgba(255,255,255,0.15)" : "#f3f4f6", color: isCustomer ? "#fff" : "#5b4fcf", fontSize: "13px", fontWeight: 600, textDecoration: "none" }, children: [
      /* @__PURE__ */ jsx5("svg", { width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", children: /* @__PURE__ */ jsx5("path", { d: "M21.44 11.05l-9.19 9.19a6 6 0 01-8.49-8.49l9.19-9.19a4 4 0 015.66 5.66l-9.2 9.19a2 2 0 01-2.83-2.83l8.49-8.48" }) }),
      /* @__PURE__ */ jsx5("span", { style: { maxWidth: "160px", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }, children: fileName })
    ] });
  };
  ...
  const Timestamps = () => isCustomer ? /* @__PURE__ */ jsxs4("div", { style: { ...styles.timestamp, display: "flex", alignItems: "center", justifyContent: "flex-end", gap: 3 }, children: [
    /* @__PURE__ */ jsx5("span", { children: time }),
    /* @__PURE__ */ jsx5(CustomerTick, { status: tickStatus })
  ] }) : /* @__PURE__ */ jsx5("div", { style: { ...styles.timestamp, textAlign: "left" }, children: time });
  return /* @__PURE__ */ jsxs4(
    "div",
    {
      ...
      children: [
        label && /* @__PURE__ */ jsx5("div", { style: styles.senderLabel, children: label }),
        /* @__PURE__ */ jsxs4("div", { style: { position: "relative", ...isAudio ? { width: "fit-content" } : { maxWidth: "82%" } }, children: [
          /* @__PURE__ */ jsxs4("div", { style: { ...bubbleStyle, ...isAudio ? {} : { maxWidth: "100%" } }, children: [
            renderReplyQuote(),
            isAttachment ? renderAttachment() : message.content,
            /* @__PURE__ */ jsx5(Timestamps, {})
          ] }),
          onReply && /* @__PURE__ */ jsx5(
            "button",
            {
              ...
              children: /* @__PURE__ */ jsx5(ReplyIcon, {})
            }
          )
        ] })
      ]
...
function QuickReplies({ replies, onSelect, primaryColor }) {
  return /* @__PURE__ */ jsxs5("div", { style: { padding: "10px 14px 12px", display: "flex", flexDirection: "column", gap: "8px", backgroundColor: "#fafafa", borderTop: "1px solid #f0f0f0", flexShrink: 0 }, children: [
    /* @__PURE__ */ jsx6("div", { style: { fontSize: "11px", color: "#9ca3af", fontWeight: 600, textTransform: "uppercase", letterSpacing: "0.06em" }, children: "How can we help?" }),
    replies.map((r) => /* @__PURE__ */ jsxs5(
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ jsx6("span", { style: { fontSize: 16 }, children: r.icon }),
          /* @__PURE__ */ jsx6("span", { children: r.label })
        ]
      },
      r.id
    ))
...
function FAQScreen({ primaryColor, onSelect, onBack }) {
  return /* @__PURE__ */ jsxs5("div", { style: { borderTop: "1px solid #f0f0f0", flexShrink: 0, backgroundColor: "#fafafa" }, children: [
    /* @__PURE__ */ jsxs5(
      "button",
      {
        onClick: onBack,
    ...
    /* @__PURE__ */ jsx6("div", { style: { padding: "2px 14px 6px", fontSize: "11px", color: "#9ca3af", fontWeight: 600, textTransform: "uppercase", letterSpacing: "0.06em" }, children: "Frequently Asked Questions" }),
    /* @__PURE__ */ jsx6("div", { style: { maxHeight: "230px", overflowY: "auto", padding: "0 14px 12px", display: "flex", flexDirection: "column", gap: "6px" }, children: FAQ_ITEMS.map((faq) => /* @__PURE__ */ jsxs5(
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ jsx6("span", { style: { fontSize: 15 }, children: faq.icon }),
          /* @__PURE__ */ jsx6("span", { children: faq.label })
        ]
      },
      faq.id
    )) })
...
function EscalatingScreen({ primaryColor, onTimeout }) {
  ...
  return /* @__PURE__ */ jsxs6("div", { style: { flex: 1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: "16px", padding: "32px", backgroundColor: "#fafafa", textAlign: "center" }, children: [
    /* @__PURE__ */ jsx7("div", { style: { fontSize: 52 }, children: "\u{1F464}" }),
    /* @__PURE__ */ jsxs6("div", { children: [
      /* @__PURE__ */ jsx7("div", { style: { fontWeight: 700, fontSize: 16, color: "#1a1a2e", marginBottom: 8 }, children: "Connecting you to an agent" }),
      /* @__PURE__ */ jsxs6("div", { style: { fontSize: 13, color: "#6b7280", lineHeight: 1.7 }, children: [
        "You've been added to the support queue.",
        /* @__PURE__ */ jsx7("br", {}),
        "An agent will join shortly."
      ] })
    ] }),
    /* @__PURE__ */ jsx7("div", { style: { display: "flex", gap: 8 }, children: [0, 0.2, 0.4].map((d, i) => /* @__PURE__ */ jsx7("div", { style: { width: 9, height: 9, borderRadius: "50%", backgroundColor: primaryColor, animation: `chatTypingBounce 1.2s ${d}s infinite ease-in-out` } }, i)) }),
    /* @__PURE__ */ jsx7("div", { style: { padding: "8px 20px", borderRadius: 20, backgroundColor: "#ede9fe", color: primaryColor, fontSize: 12, fontWeight: 700 }, children: "Est. wait: < 2 min" })
  ] });
}
function FeedbackModal({ primaryColor, onSubmit, onSkip }) {
  const [rating, setRating] = React5.useState(0);
  const [hovered, setHovered] = React5.useState(0);
  const [comment, setComment] = React5.useState("");
  const [submitted, setSubmitted] = React5.useState(false);
  ...
  if (submitted) return /* @__PURE__ */ jsxs6("div", { style: { flex: 1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: "14px", padding: "32px", backgroundColor: "#fafafa" }, children: [
    /* @__PURE__ */ jsx7("div", { style: { fontSize: 52 }, children: "\u{1F389}" }),
    /* @__PURE__ */ jsxs6("div", { style: { textAlign: "center" }, children: [
      /* @__PURE__ */ jsx7("div", { style: { fontSize: 16, fontWeight: 700, color: "#1a1a2e", marginBottom: 6 }, children: "Thank you!" }),
      /* @__PURE__ */ jsx7("div", { style: { fontSize: 13, color: "#6b7280", lineHeight: 1.6 }, children: "Your feedback helps us improve." })
    ] })
  ] });
  const active = hovered || rating;
  return /* @__PURE__ */ jsxs6("div", { style: { flex: 1, display: "flex", flexDirection: "column", backgroundColor: "#fafafa", padding: "28px 24px 20px", gap: "20px" }, children: [
    /* @__PURE__ */ jsxs6("div", { style: { textAlign: "center" }, children: [
      /* @__PURE__ */ jsx7("div", { style: { fontSize: 28, marginBottom: "10px" }, children: "\u2B50" }),
      /* @__PURE__ */ jsx7("div", { style: { fontSize: 16, fontWeight: 700, color: "#1a1a2e", marginBottom: 4 }, children: "How was your experience?" }),
      /* @__PURE__ */ jsx7("div", { style: { fontSize: 12, color: "#9ca3af", lineHeight: 1.5 }, children: "Your feedback helps us serve you better" })
    ] }),
    /* @__PURE__ */ jsxs6("div", { style: { display: "flex", flexDirection: "column", alignItems: "center", gap: "8px" }, children: [
      /* @__PURE__ */ jsx7("div", { style: { display: "flex", gap: "10px" }, children: [1, 2, 3, 4, 5].map((star) => /* @__PURE__ */ jsx7(
        "button",
        {
      ...
      active > 0 && /* @__PURE__ */ jsx7("div", { style: { fontSize: "12px", fontWeight: 600, color: primaryColor }, children: labels[active - 1] })
    ] }),
    /* @__PURE__ */ jsxs6("div", { style: { display: "flex", flexDirection: "column", gap: "6px" }, children: [
      /* @__PURE__ */ jsx7("label", { style: { fontSize: "11px", fontWeight: 600, color: "#6b7280", textTransform: "uppercase", letterSpacing: "0.05em" }, children: "Tell us more (optional)" }),
      /* @__PURE__ */ jsx7(
        "textarea",
        {
          value: comment,
    ...
    /* @__PURE__ */ jsxs6("div", { style: { display: "flex", gap: "10px" }, children: [
      /* @__PURE__ */ jsx7("button", { onClick: onSkip, style: { flex: 1, padding: "10px", borderRadius: "22px", border: "1.5px solid #e5e7eb", background: "#ffffff", color: "#6b7280", fontSize: "13px", fontWeight: 600, cursor: "pointer", fontFamily: "inherit" }, children: "Skip" }),
      /* @__PURE__ */ jsx7(
        "button",
        {
...
function EndChatConfirmModal({ onConfirm, onCancel }) {
  return /* @__PURE__ */ jsx7("div", { style: { position: "absolute", inset: 0, zIndex: 50, backgroundColor: "rgba(0,0,0,0.35)", backdropFilter: "blur(2px)", display: "flex", alignItems: "flex-end" }, children: /* @__PURE__ */ jsxs6("div", { style: { width: "100%", backgroundColor: "#ffffff", borderRadius: "20px 20px 0 0", padding: "24px 20px 28px", boxShadow: "0 -8px 32px rgba(0,0,0,0.15)", display: "flex", flexDirection: "column", gap: "16px", animation: "chatFadeIn 0.2s ease" }, children: [
    /* @__PURE__ */ jsx7("div", { style: { width: 36, height: 4, borderRadius: 2, backgroundColor: "#e5e7eb", alignSelf: "center", marginBottom: 2 } }),
    /* @__PURE__ */ jsxs6("div", { style: { textAlign: "center" }, children: [
      /* @__PURE__ */ jsx7("div", { style: { fontSize: 36, marginBottom: "10px" }, children: "\u{1F44B}" }),
      /* @__PURE__ */ jsx7("div", { style: { fontSize: 15, fontWeight: 700, color: "#1a1a2e", marginBottom: 6 }, children: "End this chat?" }),
      /* @__PURE__ */ jsxs6("div", { style: { fontSize: 13, color: "#6b7280", lineHeight: 1.6 }, children: [
        "This will close your current session.",
        /* @__PURE__ */ jsx7("br", {}),
        "You'll have a chance to leave feedback."
      ] })
    ] }),
    /* @__PURE__ */ jsxs6("div", { style: { display: "flex", gap: "10px", marginTop: 4 }, children: [
      /* @__PURE__ */ jsx7("button", { onClick: onCancel, style: { flex: 1, padding: "12px", borderRadius: "14px", border: "1.5px solid #e5e7eb", background: "#f9fafb", color: "#374151", fontSize: "14px", fontWeight: 600, cursor: "pointer", fontFamily: "inherit" }, children: "Keep Chatting" }),
      /* @__PURE__ */ jsx7("button", { onClick: onConfirm, style: { flex: 1, padding: "12px", borderRadius: "14px", border: "none", background: "linear-gradient(135deg,#ef4444,#dc2626)", color: "#ffffff", fontSize: "14px", fontWeight: 700, cursor: "pointer", fontFamily: "inherit" }, children: "End Chat" })
    ] })
  ] }) });
}
...
function WidgetHeader({ onClose, styles, subtitle, theme, onEndChat, showEndChat, onHistory, showHistory }) {
  return /* @__PURE__ */ jsxs7("div", { style: styles.header, children: [
    /* @__PURE__ */ jsx8("div", { style: styles.headerAvatar, children: "\u{1F4AC}" }),
    /* @__PURE__ */ jsxs7("div", { style: styles.headerInfo, children: [
      /* @__PURE__ */ jsx8("h3", { style: styles.headerTitle, children: "Chat Support" }),
      /* @__PURE__ */ jsxs7("div", { style: styles.headerSub, children: [
        /* @__PURE__ */ jsx8("span", { style: styles.onlineDot }),
        subtitle
      ] })
    ] }),
    onHistory && /* @__PURE__ */ jsx8(
      "button",
      {
        onClick: onHistory,
        ...
        children: showHistory ? /* @__PURE__ */ jsx8("svg", { width: "14", height: "14", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2.5", strokeLinecap: "round", strokeLinejoin: "round", children: /* @__PURE__ */ jsx8("polyline", { points: "15 18 9 12 15 6" }) }) : /* @__PURE__ */ jsxs7("svg", { width: "14", height: "14", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", children: [
          /* @__PURE__ */ jsx8("circle", { cx: "12", cy: "12", r: "10" }),
          /* @__PURE__ */ jsx8("polyline", { points: "12 6 12 12 16 14" })
        ] })
      }
    ),
    showEndChat && onEndChat && /* @__PURE__ */ jsxs7(
      "button",
      {
        onClick: onEndChat,
        title: "End chat",
        ...
        children: [
          /* @__PURE__ */ jsx8(PhoneDownIcon, {}),
          " End"
        ]
      }
    ),
    /* @__PURE__ */ jsx8("button", { style: styles.closeBtn, onClick: onClose, children: /* @__PURE__ */ jsx8(CloseIcon, {}) })
  ] });
}
...
function SessionHistoryPanel({ primaryColor, sessions, currentSessionId, onSelectActive, onReopen }) {
  const [reopening, setReopening] = useState3(null);
  ...
  const badge = (status) => {
    ...
    return /* @__PURE__ */ jsx9("span", { style: { display: "inline-block", padding: "2px 8px", borderRadius: "10px", fontSize: "10px", fontWeight: 700, background: s.bg, color: s.color, letterSpacing: "0.03em" }, children: s.label });
  };
  const renderRow = (s, isAct) => {
    ...
    return /* @__PURE__ */ jsxs8("div", { style: { padding: "12px 16px", borderBottom: "1px solid #f0f0f5", display: "flex", flexDirection: "column", gap: "6px", backgroundColor: isCurrent ? "#f9f7ff" : "#ffffff" }, children: [
      /* @__PURE__ */ jsxs8("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", gap: "8px" }, children: [
        /* @__PURE__ */ jsxs8("div", { style: { display: "flex", alignItems: "center", gap: "6px", flexWrap: "wrap" }, children: [
          badge(s.status),
          /* @__PURE__ */ jsx9("span", { style: { fontSize: "11px", color: "#9ca3af" }, children: formatDate(s.closedAt ?? s.createdAt) })
        ] }),
        isAct ? /* @__PURE__ */ jsx9(
          "button",
          {
      ...
      /* @__PURE__ */ jsx9("div", { style: { fontSize: "12px", color: "#6b7280", lineHeight: 1.4, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }, children: previewText })
    ] }, s.id);
  };
  return /* @__PURE__ */ jsxs8("div", { style: { flex: 1, overflow: "hidden", display: "flex", flexDirection: "column", backgroundColor: "#fafafa" }, children: [
    /* @__PURE__ */ jsx9("div", { style: { padding: "12px 16px 4px", fontSize: "11px", fontWeight: 700, color: "#9ca3af", textTransform: "uppercase", letterSpacing: "0.08em", backgroundColor: "#fafafa" }, children: "Active" }),
    active.length === 0 && /* @__PURE__ */ jsx9("div", { style: { padding: "12px 16px", fontSize: "13px", color: "#c4b5fd", textAlign: "center" }, children: "No active sessions" }),
    active.map((s) => renderRow(s, true)),
    /* @__PURE__ */ jsx9("div", { style: { padding: "12px 16px 4px", fontSize: "11px", fontWeight: 700, color: "#9ca3af", textTransform: "uppercase", letterSpacing: "0.08em", backgroundColor: "#fafafa", borderTop: "1px solid #f0f0f5", marginTop: "4px" }, children: "Closed" }),
    /* @__PURE__ */ jsxs8("div", { style: { flex: 1, overflowY: "auto" }, children: [
      closed.length === 0 && /* @__PURE__ */ jsx9("div", { style: { padding: "16px", fontSize: "13px", color: "#c4b5fd", textAlign: "center" }, children: "No closed sessions yet" }),
...
function ChatContentInner({ onClose, styles, config, theme, onStartNewChat, externalMessagesAreaRef }) {
  ...
  const [flowStep, setFlowStep] = useState4("menu");
  const [showQuickReplies, setShowQuickReplies] = useState4(true);
  const [escalationError, setEscalationError] = useState4(null);
  const [viewerImage, setViewerImage] = useState4(null);
  const [isRecording, setIsRecording] = useState4(false);
  const [replyTarget, setReplyTarget] = useState4(null);
  const [showEndConfirm, setShowEndConfirm] = useState4(false);
  const [showFeedback, setShowFeedback] = useState4(false);
  const [endingChat, setEndingChat] = useState4(false);
  ...
  const typingTimeoutRef = useRef3();
  const hasInited = useRef3(false);
  const prevMsgCount = useRef3(0);
  const prevSoundCount = useRef3(0);
  const messagesAreaRef = externalMessagesAreaRef;
  const messagesEndRef = useRef3(null);
  const shouldScrollBottom = useRef3(true);
  const savedScrollHeightRef = useRef3(0);
  const prevMsgCountLayoutRef = useRef3(0);
  const maxScrollTopRef = useRef3(0);
  const isRestoringScroll = useRef3(false);
  const [showJumpToBottom, setShowJumpToBottom] = useState4(false);
  const [unreadWhileScrolled, setUnreadWhileScrolled] = useState4(0);
  const renderedMsgIds = useRef3(/* @__PURE__ */ new Set());
  const hasRenderedOnce = useRef3(false);
  ...
  const waitForSession = useCallback2(() => {
    return new Promise((resolve, reject) => {
  ...
  const escalateToAgent = useCallback2(async (sessionId, reason) => {
    const cfg = configRef.current;
  ...
  const handleImageClick = useCallback2((url, fileName) => setViewerImage({ url, fileName }), []);
  const handleReply = useCallback2((m) => {
    setReplyTarget({ id: m.id, content: m.content, senderType: m.senderType, senderName: m.senderName });
    inputRef.current?.focus();
  }, []);
  const scrollToBottomNow = useCallback2((behavior = "smooth") => {
    const el = messagesAreaRef.current;
    if (el) {
  ...
  const lastMessageIdRef = useRef3(null);
  const scrollInitSeeded = useRef3(false);
  useEffect3(() => {
    if (!lastMsgId) return;
  ...
  const handleMessagesScroll = useCallback2(() => {
    const el = messagesAreaRef.current;
    if (!el) return;
  ...
  const scrollToBottom = useCallback2(() => scrollToBottomNow("smooth"), [scrollToBottomNow]);
  const sendRealMessage = useCallback2((content) => {
  ...
  const handleQuickReply = useCallback2(async (reply) => {
    setShowQuickReplies(false);
  ...
  const handleFaqSelect = useCallback2((faq) => {
  ...
  const handleEndChat = useCallback2(async () => {
  ...
  const handleAttachment = useCallback2(async (e) => {
  ...
  if (state.loading) return /* @__PURE__ */ jsxs9("div", { style: styles.widget, children: [
    /* @__PURE__ */ jsx10(WidgetHeader, { onClose, styles, subtitle: "Connecting...", theme }),
    /* @__PURE__ */ jsxs9("div", { style: styles.centeredBox, children: [
      /* @__PURE__ */ jsxs9("svg", { width: "36", height: "36", viewBox: "0 0 24 24", fill: "none", children: [
        /* @__PURE__ */ jsx10("circle", { cx: "12", cy: "12", r: "10", stroke: "#e5e7eb", strokeWidth: "3" }),
        /* @__PURE__ */ jsx10("path", { d: "M12 2a10 10 0 0 1 10 10", stroke: theme.primaryColor, strokeWidth: "3", strokeLinecap: "round", children: /* @__PURE__ */ jsx10("animateTransform", { attributeName: "transform", type: "rotate", from: "0 12 12", to: "360 12 12", dur: "0.8s", repeatCount: "indefinite" }) })
      ] }),
      /* @__PURE__ */ jsx10("span", { style: { fontSize: 13, color: "#9ca3af" }, children: "Starting chat..." })
    ] })
  ] });
  if (state.tokenExpired) return /* @__PURE__ */ jsxs9("div", { style: styles.widget, children: [
    /* @__PURE__ */ jsx10(WidgetHeader, { onClose, styles, subtitle: "Session Expired", theme }),
    /* @__PURE__ */ jsxs9("div", { style: styles.centeredBox, children: [
      /* @__PURE__ */ jsx10("div", { style: { fontSize: 40 }, children: "\u23F3" }),
      /* @__PURE__ */ jsxs9("div", { children: [
        /* @__PURE__ */ jsx10("div", { style: { fontWeight: 700, fontSize: 15, color: "#1a1a2e", marginBottom: 6 }, children: "Session Expired" }),
        /* @__PURE__ */ jsx10("div", { style: { fontSize: 13, color: "#6b7280", lineHeight: 1.5 }, children: "Your session has expired. Please refresh to continue chatting." })
      ] }),
      /* @__PURE__ */ jsx10("button", { onClick: () => window.location.reload(), style: { padding: "10px 28px", borderRadius: 22, border: "none", background: theme.primaryColor, color: "white", fontWeight: 700, cursor: "pointer", fontSize: 14, fontFamily: "inherit" }, children: "Refresh Page" })
    ] })
  ] });
  if (state.error && !state.connected) return /* @__PURE__ */ jsxs9("div", { style: styles.widget, children: [
    /* @__PURE__ */ jsx10(WidgetHeader, { onClose, styles, subtitle: "Disconnected", theme }),
    /* @__PURE__ */ jsxs9("div", { style: styles.centeredBox, children: [
      /* @__PURE__ */ jsx10("div", { style: { fontSize: 40 }, children: "\u26A0\uFE0F" }),
      /* @__PURE__ */ jsxs9("div", { children: [
        /* @__PURE__ */ jsx10("div", { style: { fontWeight: 700, fontSize: 15, color: "#1a1a2e", marginBottom: 6 }, children: "Connection Lost" }),
        /* @__PURE__ */ jsx10("div", { style: { fontSize: 13, color: "#6b7280" }, children: state.error.message })
      ] }),
      /* @__PURE__ */ jsx10("button", { onClick: () => actionsRef.current.reconnect?.(), style: { padding: "10px 28px", borderRadius: 22, border: "none", background: theme.primaryColor, color: "white", fontWeight: 700, cursor: "pointer", fontSize: 14, fontFamily: "inherit" }, children: "Retry" })
    ] })
  ] });
  return /* @__PURE__ */ jsxs9("div", { style: { ...styles.widget, position: "relative" }, children: [
    /* @__PURE__ */ jsx10(
      WidgetHeader,
      {
        onClose,
    ...
    !showHistory && /* @__PURE__ */ jsxs9(Fragment, { children: [
      showEndConfirm && /* @__PURE__ */ jsx10(EndChatConfirmModal, { primaryColor: theme.primaryColor, onConfirm: handleEndChat, onCancel: () => setShowEndConfirm(false) }),
      showFeedback ? /* @__PURE__ */ jsx10(
        FeedbackModal,
        {
          primaryColor: theme.primaryColor,
          onSubmit: () => {
      ...
      ) : flowStep === "escalating" ? /* @__PURE__ */ jsx10(EscalatingScreen, { primaryColor: theme.primaryColor, onTimeout: () => {
        setFlowStep("free");
        setShowQuickReplies(false);
      } }) : /* @__PURE__ */ jsxs9(Fragment, { children: [
        /* @__PURE__ */ jsxs9("div", { style: { ...styles.messages, position: "relative" }, ref: messagesAreaRef, onScroll: handleMessagesScroll, children: [
          state.loadingMore && /* @__PURE__ */ jsxs9("div", { style: { display: "flex", alignItems: "center", justifyContent: "center", padding: "10px 0 6px", gap: "8px" }, children: [
            /* @__PURE__ */ jsx10(SpinnerIcon, { color: theme.primaryColor, size: 16 }),
            /* @__PURE__ */ jsx10("span", { style: { fontSize: "11px", color: "#9ca3af" }, children: "Loading older messages\u2026" })
          ] }),
          !state.hasMore && allMessages.length > 0 && !state.loadingMore && /* @__PURE__ */ jsx10("div", { style: { display: "flex", alignItems: "center", justifyContent: "center", padding: "8px 0 12px" }, children: /* @__PURE__ */ jsx10("span", { style: { fontSize: "10px", fontWeight: 600, color: "#c4b5fd", backgroundColor: "#f3eeff", padding: "3px 12px", borderRadius: "10px" }, children: "Beginning of conversation" }) }),
          allMessages.map((msg) => {
            const isNew = hasRenderedOnce.current && !renderedMsgIds.current.has(msg.id);
            return /* @__PURE__ */ jsx10("div", { id: `chat-msg-${msg.id}`, style: isNew ? { animation: "chatFadeIn 0.2s ease", borderRadius: "12px" } : { borderRadius: "12px" }, children: /* @__PURE__ */ jsx10(
              MessageBubble,
              {
                message: msg,
                styles,
          ...
          state.isTyping && /* @__PURE__ */ jsx10(TypingIndicator, { styles }),
          /* @__PURE__ */ jsx10("div", { ref: messagesEndRef })
        ] }),
        showJumpToBottom && /* @__PURE__ */ jsxs9("div", { style: { position: "relative", height: 0, zIndex: 10 }, children: [
          /* @__PURE__ */ jsx10(
            "button",
            {
          ...
          unreadWhileScrolled > 0 && /* @__PURE__ */ jsx10("div", { style: { position: "absolute", bottom: "38px", right: "12px", background: theme.primaryColor, color: "#fff", fontSize: "10px", fontWeight: 700, lineHeight: 1, padding: "3px 6px", borderRadius: "10px", minWidth: "18px", textAlign: "center", boxShadow: `0 2px 6px ${theme.primaryColor}55`, pointerEvents: "none" }, children: unreadWhileScrolled > 99 ? "99+" : unreadWhileScrolled })
        ] }),
        escalationError && /* @__PURE__ */ jsxs9("div", { style: { margin: "8px 12px", padding: "10px 14px", background: "#fef2f2", border: "1px solid #fecaca", borderRadius: 10, fontSize: 12, color: "#dc2626", display: "flex", alignItems: "center", gap: 8 }, children: [
          /* @__PURE__ */ jsx10("span", { children: "\u26A0\uFE0F" }),
          /* @__PURE__ */ jsx10("span", { style: { flex: 1 }, children: escalationError }),
          /* @__PURE__ */ jsx10("button", { onClick: () => setEscalationError(null), style: { background: "none", border: "none", cursor: "pointer", color: "#9ca3af", fontSize: 18, lineHeight: 1 }, children: "\xD7" })
        ] }),
        flowStep === "faq" && /* @__PURE__ */ jsx10(FAQScreen, { primaryColor: theme.primaryColor, onSelect: handleFaqSelect, onBack: () => {
          setFlowStep("menu");
          setShowQuickReplies(true);
        } }),
        flowStep === "menu" && showQuickReplies && /* @__PURE__ */ jsx10(QuickReplies, { replies: MAIN_MENU, onSelect: handleQuickReply, primaryColor: theme.primaryColor }),
        isClosed ? state.closeReason === "SWITCHED" ? /* @__PURE__ */ jsxs9("div", { style: { padding: "16px 14px 20px", display: "flex", flexDirection: "column", alignItems: "center", gap: "12px", borderTop: "1px solid #f0f0f5", backgroundColor: "#fafafa" }, children: [
          /* @__PURE__ */ jsx10("div", { style: { fontSize: 28 }, children: "\u23F8" }),
          /* @__PURE__ */ jsxs9("div", { style: { textAlign: "center" }, children: [
            /* @__PURE__ */ jsx10("div", { style: { fontSize: 13, fontWeight: 700, color: "#374151", marginBottom: 4 }, children: "Chat on Hold" }),
            /* @__PURE__ */ jsxs9("div", { style: { fontSize: 12, color: "#9ca3af", lineHeight: 1.5 }, children: [
              "This chat was put on hold while you switched to another session.",
              /* @__PURE__ */ jsx10("br", {}),
              "You can resume it from your chat history."
            ] })
          ] }),
          onStartNewChat && /* @__PURE__ */ jsx10("button", { onClick: onStartNewChat, style: { padding: "10px 24px", borderRadius: 22, border: "none", background: `linear-gradient(135deg,${theme.primaryColor},${theme.primaryColor}cc)`, color: "white", fontWeight: 700, cursor: "pointer", fontSize: 13, fontFamily: "inherit" }, children: "+ Start New Chat" })
        ] }) : /* @__PURE__ */ jsxs9("div", { style: { padding: "16px 14px 20px", display: "flex", flexDirection: "column", alignItems: "center", gap: "12px", borderTop: "1px solid #f0f0f5", backgroundColor: "#fafafa" }, children: [
          /* @__PURE__ */ jsx10("div", { style: { fontSize: 28 }, children: "\u2705" }),
          /* @__PURE__ */ jsxs9("div", { style: { textAlign: "center" }, children: [
            /* @__PURE__ */ jsx10("div", { style: { fontSize: 13, fontWeight: 700, color: "#374151", marginBottom: 4 }, children: "Chat Ended" }),
            /* @__PURE__ */ jsxs9("div", { style: { fontSize: 12, color: "#9ca3af", lineHeight: 1.5 }, children: [
          ...
          onStartNewChat && /* @__PURE__ */ jsx10("button", { onClick: onStartNewChat, style: { padding: "10px 24px", borderRadius: 22, border: "none", background: `linear-gradient(135deg,${theme.primaryColor},${theme.primaryColor}cc)`, color: "white", fontWeight: 700, cursor: "pointer", fontSize: 13, fontFamily: "inherit" }, children: "+ Start New Chat" })
        ] }) : /* @__PURE__ */ jsxs9("div", { style: { flexShrink: 0 }, children: [
          state.uploading && /* @__PURE__ */ jsxs9("div", { style: { padding: "8px 14px", backgroundColor: theme.primaryColor + "10", borderTop: `1px solid ${theme.primaryColor}30`, display: "flex", alignItems: "center", gap: "8px" }, children: [
            /* @__PURE__ */ jsxs9("svg", { width: "15", height: "15", viewBox: "0 0 24 24", fill: "none", style: { flexShrink: 0 }, children: [
              /* @__PURE__ */ jsx10("circle", { cx: "12", cy: "12", r: "10", stroke: "#e5e7eb", strokeWidth: "3" }),
              /* @__PURE__ */ jsx10("path", { d: "M12 2a10 10 0 0 1 10 10", stroke: theme.primaryColor, strokeWidth: "3", strokeLinecap: "round", children: /* @__PURE__ */ jsx10("animateTransform", { attributeName: "transform", type: "rotate", from: "0 12 12", to: "360 12 12", dur: "0.8s", repeatCount: "indefinite" }) })
            ] }),
            /* @__PURE__ */ jsx10("div", { style: { flex: 1, height: "3px", borderRadius: "2px", backgroundColor: theme.primaryColor + "25", overflow: "hidden" }, children: /* @__PURE__ */ jsx10("div", { style: { height: "100%", borderRadius: "2px", backgroundColor: theme.primaryColor, animation: "chatUploadPulse 1.4s ease-in-out infinite" } }) }),
            /* @__PURE__ */ jsx10("span", { style: { fontSize: "11px", color: theme.primaryColor, fontWeight: 600, flexShrink: 0 }, children: "Uploading\u2026" })
          ] }),
          replyTarget && /* @__PURE__ */ jsxs9("div", { style: { padding: "8px 12px", borderTop: "1px solid #f0f0f5", backgroundColor: "#f9fafb", display: "flex", alignItems: "center", gap: "8px" }, children: [
            /* @__PURE__ */ jsxs9("div", { style: { flex: 1, borderLeft: `3px solid ${theme.primaryColor}`, paddingLeft: "10px", overflow: "hidden" }, children: [
              /* @__PURE__ */ jsx10("div", { style: { fontSize: "11px", fontWeight: 700, color: theme.primaryColor, marginBottom: "1px" }, children: replyTarget.senderType === "CUSTOMER" ? "You" : replyTarget.senderName || "Agent" }),
              /* @__PURE__ */ jsx10("div", { style: { fontSize: "12px", color: "#6b7280", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }, children: replyTarget.content?.length > 80 ? replyTarget.content.slice(0, 80) + "\u2026" : replyTarget.content })
            ] }),
            /* @__PURE__ */ jsx10("button", { onClick: () => setReplyTarget(null), style: { background: "none", border: "none", cursor: "pointer", color: "#9ca3af", fontSize: "18px", lineHeight: 1, padding: "2px", flexShrink: 0 }, children: "\xD7" })
          ] }),
          /* @__PURE__ */ jsxs9("div", { style: styles.inputArea, children: [
            /* @__PURE__ */ jsx10("input", { type: "file", ref: fileInputRef, style: { display: "none" }, accept: "image/*,video/*,audio/*,.pdf,.doc,.docx,.xls,.xlsx,.csv,.txt,.zip,.rar", onChange: handleAttachment }),
            /* @__PURE__ */ jsx10(
              "button",
              {
                ...
                children: /* @__PURE__ */ jsx10("svg", { width: "20", height: "20", viewBox: "0 0 24 24", fill: "none", stroke: "#6b7280", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", children: /* @__PURE__ */ jsx10("path", { d: "M21.44 11.05l-9.19 9.19a6 6 0 01-8.49-8.49l9.19-9.19a4 4 0 015.66 5.66l-9.2 9.19a2 2 0 01-2.83-2.83l8.49-8.48" }) })
              }
            ),
            /* @__PURE__ */ jsx10(
              "button",
              {
                ...
                children: isRecording ? /* @__PURE__ */ jsx10("svg", { width: "14", height: "14", viewBox: "0 0 24 24", fill: "#fff", children: /* @__PURE__ */ jsx10("rect", { x: "4", y: "4", width: "16", height: "16", rx: "2" }) }) : /* @__PURE__ */ jsxs9("svg", { width: "18", height: "18", viewBox: "0 0 24 24", fill: "none", stroke: "#6b7280", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", children: [
                  /* @__PURE__ */ jsx10("rect", { x: "9", y: "1", width: "6", height: "11", rx: "3" }),
                  /* @__PURE__ */ jsx10("path", { d: "M19 10v1a7 7 0 01-14 0v-1" }),
                  /* @__PURE__ */ jsx10("line", { x1: "12", y1: "19", x2: "12", y2: "23" }),
                  /* @__PURE__ */ jsx10("line", { x1: "8", y1: "23", x2: "16", y2: "23" })
                ] })
              }
            ),
            /* @__PURE__ */ jsx10(
            ...
            /* @__PURE__ */ jsx10(
              "button",
              {
                ...
                children: /* @__PURE__ */ jsx10(SendIcon, { active: !!isActive })
              }
            )
          ] })
        ] })
    ...
    viewerImage && /* @__PURE__ */ jsxs9("div", { onClick: () => setViewerImage(null), style: { position: "fixed", top: 0, left: 0, right: 0, bottom: 0, backgroundColor: "rgba(0,0,0,0.85)", zIndex: 1e5, display: "flex", alignItems: "center", justifyContent: "center", cursor: "zoom-out" }, children: [
      /* @__PURE__ */ jsx10("button", { onClick: () => setViewerImage(null), style: { position: "absolute", top: 16, right: 16, background: "rgba(255,255,255,0.15)", border: "none", borderRadius: "50%", width: 40, height: 40, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", color: "#fff", fontSize: 22, fontWeight: 700, backdropFilter: "blur(4px)" }, "aria-label": "Close", children: "\xD7" }),
      /* @__PURE__ */ jsx10("a", { href: viewerImage.url, download: viewerImage.fileName, target: "_blank", rel: "noopener noreferrer", onClick: (e) => e.stopPropagation(), style: { position: "absolute", top: 16, right: 68, background: "rgba(255,255,255,0.15)", border: "none", borderRadius: "50%", width: 40, height: 40, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", color: "#fff", backdropFilter: "blur(4px)", textDecoration: "none" }, "aria-label": "Download", children: /* @__PURE__ */ jsxs9("svg", { width: "18", height: "18", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", children: [
        /* @__PURE__ */ jsx10("path", { d: "M21 15v4a2 2 0 01-2 2H5a2 2 0 01-2-2v-4" }),
        /* @__PURE__ */ jsx10("polyline", { points: "7 10 12 15 17 10" }),
        /* @__PURE__ */ jsx10("line", { x1: "12", y1: "15", x2: "12", y2: "3" })
      ] }) }),
      /* @__PURE__ */ jsx10("div", { onClick: (e) => e.stopPropagation(), style: { position: "absolute", top: 20, left: 16, right: 120, color: "#fff", fontSize: 13, fontWeight: 500, opacity: 0.8, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }, children: viewerImage.fileName }),
      /* @__PURE__ */ jsx10("img", { src: viewerImage.url, alt: viewerImage.fileName, onClick: (e) => e.stopPropagation(), style: { maxWidth: "90vw", maxHeight: "85vh", objectFit: "contain", borderRadius: 8, boxShadow: "0 8px 40px rgba(0,0,0,0.5)", cursor: "default" } })
    ] })
  ] });
}
function ChatContentWithScrollRef({ scrollToBottomRef, ...props }) {
  const localMessagesAreaRef = useRef3(null);
  useEffect3(() => {
  ...
  return /* @__PURE__ */ jsx10(ChatContentInner, { ...props, externalMessagesAreaRef: localMessagesAreaRef });
}
...
function UnreadTracker({ isOpen, onUnreadChange, onTicketChange }) {
  const { state, actions } = useChat();
  const setWidgetOpenRef = useRef4(actions.setWidgetOpen);
...
function ChatWidget({ config, defaultOpen = false }) {
  const [isOpen, setIsOpen] = useState5(defaultOpen);
  const [launchHover, setLaunchHover] = useState5(false);
  const [chatKey, setChatKey] = useState5(0);
  const [unreadCount, setUnreadCount] = useState5(0);
  const [ticketId, setTicketId] = useState5(null);
  const handleTicketChange = useCallback3((id) => setTicketId(id), []);
  const handleUnreadChange = useCallback3((count) => setUnreadCount(count), []);
  const theme = { ...defaultTheme, ...config.theme };
  const styles = getStyles(config.theme);
  const scrollToBottomRef = useRef4(null);
  const handleStartNewChat = () => setChatKey((k) => k + 1);
  const prevIsOpen = useRef4(isOpen);
  useEffect4(() => {
  ...
  return /* @__PURE__ */ jsxs10("div", { style: styles.container, children: [
    !isOpen && /* @__PURE__ */ jsxs10(
      "button",
      {
        ...
        children: [
          ...
          unreadCount > 0 && /* @__PURE__ */ jsx11("span", { style: { position: "absolute", top: "-4px", right: "-4px", minWidth: "20px", height: "20px", borderRadius: "10px", backgroundColor: "#ef4444", color: "#ffffff", fontSize: "11px", fontWeight: 700, display: "flex", alignItems: "center", justifyContent: "center", padding: "0 5px", boxShadow: "0 2px 6px rgba(239,68,68,0.5)", border: "2px solid #ffffff", fontFamily: "system-ui,sans-serif", lineHeight: 1 }, children: unreadCount > 99 ? "99+" : unreadCount }),
          ticketId && /* @__PURE__ */ jsxs10("span", { style: { position: "absolute", bottom: "-4px", left: "-4px", backgroundColor: "#7c3aed", color: "#fff", fontSize: "9px", fontWeight: 700, padding: "2px 5px", borderRadius: "8px", border: "2px solid #fff", lineHeight: 1.2, whiteSpace: "nowrap", boxShadow: "0 2px 6px rgba(124,58,237,0.5)" }, children: [
            "\u{1F3AB} #",
            ticketId
          ] })
        ]
    ...
    /* @__PURE__ */ jsxs10(ChatProvider, { config, children: [
      /* @__PURE__ */ jsx11(UnreadTracker, { isOpen, onUnreadChange: handleUnreadChange, onTicketChange: handleTicketChange }),
      /* @__PURE__ */ jsx11("div", { style: { display: isOpen ? "block" : "none" }, children: /* @__PURE__ */ jsx11(
