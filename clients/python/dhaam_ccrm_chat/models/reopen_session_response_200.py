...
T = TypeVar("T", bound="ReopenSessionResponse200")


@_attrs_define
class ReopenSessionResponse200:
    """
    Attributes:
        success (bool):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        reopen_session_response_200 = cls(
            success=success,
            data=data,
        )

        reopen_session_response_200.additional_properties = d
        return reopen_session_response_200
