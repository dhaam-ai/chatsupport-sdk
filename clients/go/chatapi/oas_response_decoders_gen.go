...
func decodeCreateSessionResponse(resp *http.Response) (res CreateSessionRes, _ error) {
	...
	case 201:
		...
		case ct == "application/json":
			...
			var wrapper ChatSessionHeaders
			wrapper.Response = response
			h := uri.NewHeaderDecoder(resp.Header)
...
func decodeListSessionsResponse(resp *http.Response) (res ListSessionsRes, _ error) {
	...
	case 200:
		...
		case ct == "application/json":
			...
			var response SessionSummaryPage
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
...
func decodeUploadSessionAttachmentResponse(resp *http.Response) (res UploadSessionAttachmentRes, _ error) {
	switch resp.StatusCode {
	case 201:
		// Code 201.
		ct, _, err := mime.ParseMediaType(resp.Header.Get("Content-Type"))
	...
	case 413:
		...
		case ct == "application/json":
			...
			var response UploadSessionAttachmentRequestEntityTooLarge
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
	...
	case 415:
		...
		case ct == "application/json":
			...
			var response UploadSessionAttachmentUnsupportedMediaType
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
